...
weatherBtn.addEventListener("click", () => {
    ...
    const aqi_Index = document.getElementById("aqi_Index");
    const aq_level = document.getElementById("aq_level");
      fetch(`http://api.openweathermap.org/data/2.5/air_pollution?lat=${lat}&lon=${lon}&appid=beea3435003dac5511b106b3cd2c6350`)
      .then((res) => res.json())
      .then((data1) => {
        console.log(data1);
